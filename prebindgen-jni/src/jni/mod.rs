...
pub(crate) enum Engine {
    ...
    #[cfg(feature = "v2")]
    V2(Box<prebindgen_registry_v2::Generation<crate::v2::JniTarget>>),
}
...
impl JniGen {
    ...
    pub(crate) fn from_v2(
        decls: Declarations,
        generation: prebindgen_registry_v2::Generation<crate::v2::JniTarget>,
    ) -> Self {
        JniGen {
            decls,
        ...
        match &self.engine {
            ...
            Engine::V2(_) => panic!(
                "`JniGen::registry` is the v1 engine's resolution; this binding was \
                 generated by v2. Read `JniGen::skipped()` instead"
            ),
        }
    }
