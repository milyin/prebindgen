...
public fun LedgerCallback.asRaw(): LedgerCallbackRaw =
    LedgerCallbackRaw {
        ...
        run(
            ...
            ledgerFiled__origin__secs,
            ledgerFiled__origin__nanos,
            when (ledgerFiled__outcome__tag) { 0 -> Lookup.Absent; 1 -> Lookup.Found(Summary(ledgerFiled__outcome__found_v0!!)); 2 -> Lookup.Failed(ledgerFiled__outcome__failed_v0!!); else -> throw IllegalArgumentException("Lookup: invalid tag $ledgerFiled__outcome__tag") },
            ledgerFiled__label,
            ledgerArchived__summary__count,
            ledgerArchived__summary__total,
            ledgerArchived__taken,
            ledgerArchived__origin__secs,
            ledgerArchived__origin__nanos,
            when (ledgerArchived__outcome__tag) { 0 -> Lookup.Absent; 1 -> Lookup.Found(Summary(ledgerArchived__outcome__found_v0!!)); 2 -> Lookup.Failed(ledgerArchived__outcome__failed_v0!!); else -> throw IllegalArgumentException("Lookup: invalid tag $ledgerArchived__outcome__tag") },
            ledgerArchived__label
        )
    }
