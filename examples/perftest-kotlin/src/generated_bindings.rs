...
pub unsafe extern "C" fn Java_io_prebindgen_perftest_JNINative_storageCallback<'a>(
    ...
    let __out = perftest_flat::storage_callback(&s, f);
...
pub unsafe extern "C" fn Java_io_prebindgen_perftest_JNINative_storageGet<'a>(
    ...
    let __obj0: jni::sys::jvalue = {
        let __enc0 = match i64_to_jlong_fbf9a9bc(&mut env, __out.id.clone()) {
            ::core::result::Result::Ok(__w) => __w,
            ::core::result::Result::Err(__e) => {
                let __zd = __ze_defaults(&mut env);
                signal_error(
    ...
    let __obj1: jni::sys::jvalue = {
        let __enc1 = match i32_to_jint_a3e3b6ef(&mut env, __out.seq.clone()) {
            ::core::result::Result::Ok(__w) => __w,
            ::core::result::Result::Err(__e) => {
                let __zd = __ze_defaults(&mut env);
                signal_error(
    ...
    let __obj2: jni::sys::jvalue = {
        let __enc2 = match f64_to_jdouble_9e4a8f70(&mut env, __out.value.clone()) {
            ::core::result::Result::Ok(__w) => __w,
            ::core::result::Result::Err(__e) => {
                let __zd = __ze_defaults(&mut env);
                signal_error(
    ...
    let __obj3: jni::sys::jvalue = {
        let __enc3 = match bool_to_jboolean_31306d98(&mut env, __out.flag.clone()) {
            ::core::result::Result::Ok(__w) => __w,
            ::core::result::Result::Err(__e) => {
                let __zd = __ze_defaults(&mut env);
                signal_error(
...
#[no_mangle]
#[allow(non_snake_case, unused_mut, unused_variables, dead_code)]
pub unsafe extern "C" fn Java_io_prebindgen_perftest_JNINative_storageGetFlag<'a>(
    mut env: jni::JNIEnv<'a>,
    _class: jni::objects::JClass<'a>,
    s: jni::sys::jlong,
    __error_sink: jni::objects::JObject<'a>,
    ...
    let __out = perftest_flat::storage_get_flag(&s);
...
#[no_mangle]
#[allow(non_snake_case, unused_mut, unused_variables, dead_code)]
pub unsafe extern "C" fn Java_io_prebindgen_perftest_JNINative_storageGetId<'a>(
    mut env: jni::JNIEnv<'a>,
    _class: jni::objects::JClass<'a>,
    s: jni::sys::jlong,
    __error_sink: jni::objects::JObject<'a>,
    ...
    let __out = perftest_flat::storage_get_id(&s);
...
#[no_mangle]
#[allow(non_snake_case, unused_mut, unused_variables, dead_code)]
pub unsafe extern "C" fn Java_io_prebindgen_perftest_JNINative_storageGetLabel<'a>(
    mut env: jni::JNIEnv<'a>,
    _class: jni::objects::JClass<'a>,
    s: jni::sys::jlong,
    __error_sink: jni::objects::JObject<'a>,
    ...
    let __out = perftest_flat::storage_get_label(&s);
...
#[no_mangle]
#[allow(non_snake_case, unused_mut, unused_variables, dead_code)]
pub unsafe extern "C" fn Java_io_prebindgen_perftest_JNINative_storageGetSeq<'a>(
    mut env: jni::JNIEnv<'a>,
    _class: jni::objects::JClass<'a>,
    s: jni::sys::jlong,
    __error_sink: jni::objects::JObject<'a>,
    ...
    let __out = perftest_flat::storage_get_seq(&s);
...
#[no_mangle]
#[allow(non_snake_case, unused_mut, unused_variables, dead_code)]
pub unsafe extern "C" fn Java_io_prebindgen_perftest_JNINative_storageGetValue<'a>(
    mut env: jni::JNIEnv<'a>,
    _class: jni::objects::JClass<'a>,
    s: jni::sys::jlong,
    __error_sink: jni::objects::JObject<'a>,
    ...
    let __out = perftest_flat::storage_get_value(&s);
