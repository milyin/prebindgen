...
// signature.
pub(crate) use prebindgen::core::types_util::{
...
/// path needs a gravestone write-back (and thus a [`prebindgen::core::Gravestone`]
...
enum OpaqueKind {
    ...
    /// Consuming must write a [`prebindgen::core::Gravestone`] back over the moved-from
...
pub struct Cbindgen {
    ...
    pub(crate) registry: prebindgen::core::Registry<()>,
}
...
impl Cbindgen {
    ...
    pub fn registry(&self) -> &prebindgen::core::Registry<()> {
        &self.registry
    }
...
fn payload_enum<'r>(
    ...
    key: &TypeKey,
) -> Option<&'r prebindgen::core::flat::Variant> {
    match registry.flat().declared_type(&key.ident()?)? {
        prebindgen::core::flat::Type::Variant(v) => Some(v),
        prebindgen::core::flat::Type::Enum(e) => panic!(
...
pub fn snake_case(s: &str) -> String {
    prebindgen::core::types_util::pascal_to_snake(s)
}
...
fn spelled(t: &TypeRef, emit: &prebindgen::core::Emit) -> syn::Type {
