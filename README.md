...
### Relation to Diplomat

[`Diplomat`](https://github.com/rust-diplomat/diplomat) is a mature multi-language FFI generator for Rust libraries. `prebindgen` explores a different set of trade-offs:

- **Per-language ABI freedom**: destination crates choose their own adapter and wire representation instead of sharing one generated C ABI for every language.
