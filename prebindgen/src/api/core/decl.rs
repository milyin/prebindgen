...
macro_rules! fun {
    ($name:ident) => {
        $crate::core::FunctionDecl::new($crate::ident!($name))
    };
    ($path:path) => {
        $crate::core::FunctionDecl::new_local($crate::__macro_support::parse_path(stringify!(
            $path
        )))
    };
}
...
macro_rules! convert {
    ($t:ty) => {
        $crate::core::ConvertDecl::new($crate::__macro_support::parse_type(stringify!($t)))
    };
}
...
macro_rules! expand_param {
    ($t:ty) => {
        $crate::core::ExpandParamDecl::new($crate::__macro_support::parse_type(stringify!($t)))
    };
}
...
macro_rules! from {
    ($t:ty) => {
        $crate::core::ConvertSourceDecl::from_type($crate::__macro_support::parse_type(stringify!(
            $t
        )))
    };
}
...
macro_rules! try_from {
    ($t:ty) => {
        $crate::core::ConvertSourceDecl::try_from_type($crate::__macro_support::parse_type(
            stringify!($t),
        ))
    };
}
...
macro_rules! into {
    ($t:ty) => {
        $crate::core::ConvertSourceDecl::into_type($crate::__macro_support::parse_type(stringify!(
            $t
        )))
    };
}
...
macro_rules! try_into {
    ($t:ty) => {
        $crate::core::ConvertSourceDecl::try_into_type($crate::__macro_support::parse_type(
            stringify!($t),
        ))
    };
}
...
macro_rules! expand_return {
    ($t:ty) => {
        $crate::core::ExpandReturnDecl::new($crate::__macro_support::parse_type(stringify!($t)))
    };
}
...
macro_rules! fields {
    ($name:ident) => {
        $crate::core::FieldsDecl::new($crate::ident!($name))
    };
}
