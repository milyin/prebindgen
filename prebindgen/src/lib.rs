...
pub mod core {
    ...
    pub use crate::api::core::{
        warn_unclaimed, Claimed, ConverterImpl, Direction, DomainScalar, Element, Flat, Generation,
        Gravestone, NicheSlot, Niches, Prebindgen, Registry, RepresentationDomain, ScalarValue,
