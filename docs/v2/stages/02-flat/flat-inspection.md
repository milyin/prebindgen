<!-- spec: {"contract": "flat-inspection", "kind": "contract", "stage": "02-flat"} -->

[Pipeline chapter](../02-flat.md) · [Project contents](../../README.md)
...
A view is a read-only handle that retains the [source snapshot](flat-model.md#building-and-retaining-a-model)
