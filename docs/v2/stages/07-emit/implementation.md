<!-- spec: {"contract": "implementation", "kind": "contract", "stage": "07-emit"} -->

[Pipeline chapter](../07-emit.md) · [Project contents](../../README.md)
...
- [ ] The [Flat V2 project](../02-flat/flat-overview.md) supplies checked source views; the registry validates snapshot association and derives conversion keys privately.
