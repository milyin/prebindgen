<!-- spec: {"contract": "primitive-examples", "kind": "contract", "stage": "07-emit"} -->

[Pipeline chapter](../07-emit.md) · [Project contents](../../README.md)

# Concrete primitive examples: C and Kotlin/JNI

With [conversion plans](../05-boundary/plans.md) assembled and [supported output retained](../06-retain/generation.md),
