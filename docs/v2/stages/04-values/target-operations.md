<!-- spec: {"contract": "target-operations", "kind": "contract", "stage": "04-values"} -->
...
in section [7](../05-boundary/plans.md).
...
The [C and Kotlin/JNI examples](../07-emit/primitive-examples.md) show a complete foreign declaration and native wrapper, the primitive specifications behind their input operations, and the exact ownership of each generated fragment.
