...
- [Source construction and decomposition](04-values/source-relations.md)
- [Individual target operations](04-values/target-operations.md)
- [Target representations and composition](04-values/representations.md)
- [The target adapter interface](04-values/target-interface.md)
