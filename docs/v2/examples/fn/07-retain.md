...
Owner: the registry · Previous: [Assemble the wrapper boundary][fn_boundary] · Next: [Emit bindings][fn_emit]
...
exported symbol. Both symbols are shown here to connect the retained request to
...
- Nothing partial is retained: no
  [wrapper](../../stages/06-boundary.md#assemble-the-wrapper-boundary) can call a conversion that was not retained.
