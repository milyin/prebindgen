...
name `Stamp`. Later planning can use its fields if the selected [representation](../../stages/05-represent.md#represent-and-compose-values)
requires structural [conversion](../../stages/04-select.md#select-conversion-relations).
