...
No additional Rust boundary struct is needed for this [representation](../../stages/05-represent.md#represent-and-compose-values). The native
[wrapper](../../stages/06-boundary.md#assemble-the-native-boundary) receives a `JObject`, reads the getters and constructs the existing
