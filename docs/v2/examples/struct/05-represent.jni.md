...
Owner: the registry; the JNI frontend states the object [wire type](../../stages/05-represent.md#describing-target-values-and-operations) and its getter
...
binds to `env`, the part, and the wire type the part resolved to — a `jlong`
